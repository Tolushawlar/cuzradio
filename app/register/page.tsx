        ...
        <main className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center mt-10 mb-20'>
            <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
                <div className='w-3/5 p-5'>
                    ...
                    <div className='py-10'>
                        <h2 className='text-3xl font-bold text-red-500 mb-2'>Register new account</h2>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <a href='#' className='border-2 border-red-500 text-red-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-red-500 hover:text-white'>Register</a>
                        </div>
                    </div>
                </div>
                <div className='w-2/5 bg-red-500 text-white rounded-tr-2xl rounded-br-2xl p-10 px-12'>
                    ...
                    <a href='/login' className='border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-red-500'>Login</a>
                </div>
            </div>
        </main>
    )
